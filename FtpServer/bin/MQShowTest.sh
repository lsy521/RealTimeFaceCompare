...
LOG_FILE=${LOG_DIR}/MQShow-test.log
...
function start_consumer()
{
    ...
    java -classpath $CONF_DIR:$LIB_JARS:$COMMON_JARS com.hzgc.ftpserver.captureSubscription.MQShowTest | tee -a  ${LOG_FILE}
}
#########################################################################
# 函数名：main
# 描述：脚本主要入口
